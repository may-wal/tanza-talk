...
// appear in.
//
// Order: hero pitch → audience self-select (+ client logos) → what's new →
// what we do → whose voices → what we've published → how it works → why the
// founder started it → contact.
//
